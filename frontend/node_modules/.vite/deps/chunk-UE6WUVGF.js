...
// node_modules/@web3modal/common/node_modules/dayjs/dayjs.min.js
var require_dayjs_min = __commonJS({
  "node_modules/@web3modal/common/node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n = 36e5, r = "millisecond", i = "second", s2 = "minute", u = "hour", a2 = "day", o = "week", c2 = "month", f = "quarter", h2 = "year", d2 = "date", l2 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        return { M: c2, y: h2, w: o, d: a2, D: d2, h: u, m: s2, s: i, ms: r, Q: f }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g = "en", D = {};
      D[g] = M;
      ...
      var _ = function() {
        ...
        return m2.parse = function(t3) {
          ...
          var n2 = this, r2 = !!b.u(e3) || e3, f2 = b.p(t3), l3 = function(t4, e4) {
          ...
          var n2, o2 = b.p(t3), f2 = "set" + (this.$u ? "UTC" : ""), l3 = (n2 = {}, n2[a2] = f2 + "Date", n2[d2] = f2 + "Date", n2[c2] = f2 + "Month", n2[h2] = f2 + "FullYear", n2[u] = f2 + "Hours", n2[s2] = f2 + "Minutes", n2[i] = f2 + "Seconds", n2[r] = f2 + "Milliseconds", n2)[o2], $2 = o2 === a2 ? this.$D + (e3 - this.$W) : e3;
          if (o2 === c2 || o2 === h2) {
          ...
          if ($2 === a2) return y3(1);
          if ($2 === o) return y3(7);
          var M3 = (d3 = {}, d3[s2] = e2, d3[u] = n, d3[i] = t2, d3)[$2] || 1, m3 = this.$d.getTime() + r2 * M3;
          return b.w(m3, this);
          ...
          var r2 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i2 = b.z(this), s3 = this.$H, u2 = this.$m, a3 = this.$M, o2 = n2.weekdays, c3 = n2.months, f2 = n2.meridiem, h3 = function(t4, n3, i3, s4) {
        ...
        }, m2.diff = function(r2, d3, l3) {
          var $2, y3 = this, M3 = b.p(d3), m3 = O(r2), v2 = (m3.utcOffset() - this.utcOffset()) * e2, g2 = this - m3, D2 = function() {
            return b.m(y3, m3);
          };
          switch (M3) {
            case h2:
      ...
      return O.prototype = k, [["$ms", r], ["$s", i], ["$m", s2], ["$H", u], ["$W", a2], ["$M", c2], ["$y", h2], ["$D", d2]].forEach(function(t3) {
        k[t3[1]] = function(e3) {
...
// node_modules/@web3modal/common/node_modules/dayjs/locale/en.js
var require_en = __commonJS({
  "node_modules/@web3modal/common/node_modules/dayjs/locale/en.js"(exports, module) {
    !function(e2, n) {
...
// node_modules/@web3modal/common/node_modules/dayjs/plugin/relativeTime.js
var require_relativeTime = __commonJS({
  "node_modules/@web3modal/common/node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !function(r, e2) {
      ...
      return function(r, e2, t2) {
        ...
        function i(r2, e3, t3, o2) {
          return n.fromToBase(r2, e3, t3, o2);
        }
        t2.en.relativeTime = o, n.fromToBase = function(e3, n2, i2, d3, u) {
          for (var f, a2, s2, l2 = i2.$locale().relativeTime || o, h2 = r.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m = h2.length, c2 = 0; c2 < m; c2 += 1) {
            var y2 = h2[c2];
            y2.d && (f = d3 ? t2(e3).diff(i2, y2.d, true) : i2.diff(e3, y2.d, true));
            var p2 = (r.rounding || Math.round)(Math.abs(f));
            if (s2 = f > 0, p2 <= y2.r || !y2.r) {
              p2 <= 1 && c2 > 0 && (y2 = h2[c2 - 1]);
              var v = l2[y2.l];
              u && (p2 = u("" + p2)), a2 = "string" == typeof v ? v.replace("%d", p2) : v(p2, n2, y2.l, s2);
              break;
            }
          }
          if (n2) return a2;
...
// node_modules/@web3modal/common/node_modules/dayjs/plugin/updateLocale.js
var require_updateLocale = __commonJS({
  "node_modules/@web3modal/common/node_modules/dayjs/plugin/updateLocale.js"(exports, module) {
    !function(e2, n) {
...
// node_modules/@web3modal/core/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/@web3modal/core/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    "use strict";
    if (true) {
      (function() {
        "use strict";
...
// node_modules/@web3modal/core/node_modules/use-sync-external-store/shim/index.js
var require_shim = __commonJS({
  "node_modules/@web3modal/core/node_modules/use-sync-external-store/shim/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
function clone(configObject) {
  ...
  function BigNumber2(v, b) {
    var alphabet, c2, caseChanged, e2, i, isNum, len, str, x = this;
  ...
  BigNumber2.random = function() {
    ...
    return function(dp) {
      var a2, b, e2, k, v, i = 0, c2 = [], rand = new BigNumber2(ONE);
  ...
  convertBase = /* @__PURE__ */ function() {
    ...
    return function(str, baseIn, baseOut, sign, callerIsToString) {
      var alphabet, d2, e2, k, r, x, xc, y2, i = str.indexOf("."), dp = DECIMAL_PLACES, rm = ROUNDING_MODE;
      if (i >= 0) {
        k = POW_PRECISION;
        POW_PRECISION = 0;
        str = str.replace(".", "");
  ...
  div = /* @__PURE__ */ function() {
    ...
    return function(x, y2, dp, rm, base) {
      var cmp, e2, i, more, n, prod, prodL, q, qc, rem, remL, rem0, xi, xL, yc0, yL, yz, s2 = x.s == y2.s ? 1 : -1, xc = x.c, yc = y2.c;
      if (!xc || !xc[0] || !yc || !yc[0]) {
  ...
  function maxOrMin(args, n) {
    ...
    for (; i < args.length; i++) {
      ...
      if (!y2.s || (k = compare(x, y2)) === n || k === 0 && x.s === n) {
        x = y2;
      }
    }
    return x;
  ...
  P.minus = function(y2, b) {
    ...
    if (!xe || !ye) {
      if (!xc || !yc) return xc ? (y2.s = -b, y2) : new BigNumber2(yc ? x : NaN);
      if (!xc[0] || !yc[0]) {
  ...
  P.modulo = P.mod = function(y2, b) {
    ...
    if (!y2.c[0] && MODULO_MODE == 1) y2.s = x.s;
    return y2;
  };
  P.multipliedBy = P.times = function(y2, b) {
    var c2, e2, i, j, k, m, xcL, xlo, xhi, ycL, ylo, yhi, zc, base, sqrtBase, x = this, xc = x.c, yc = (y2 = new BigNumber2(y2, b)).c;
    if (!xc || !yc || !xc[0] || !yc[0]) {
  ...
  P.plus = function(y2, b) {
    ...
    if (!xe || !ye) {
      ...
      if (!xc[0] || !yc[0]) return yc[0] ? y2 : new BigNumber2(xc[0] ? x : a2 * 0);
    }
    xe = bitFloor(xe);
    ye = bitFloor(ye);
    xc = xc.slice();
  ...
  P.squareRoot = P.sqrt = function() {
    var m, n, r, rep, t2, x = this, c2 = x.c, s2 = x.s, e2 = x.e, dp = DECIMAL_PLACES + 4, half = new BigNumber2("0.5");
    if (s2 !== 1 || !c2 || !c2[0]) {
  ...
  P.toFraction = function(md) {
    var d2, d0, d1, d22, e2, exp, n, n0, n1, q, r, s2, x = this, xc = x.c;
    if (md != null) {
      n = new BigNumber2(md);
    ...
    md = !md || n.comparedTo(d2) > 0 ? e2 > 0 ? d2 : n1 : n;
    exp = MAX_EXP;
    MAX_EXP = 1 / 0;
    n = new BigNumber2(s2);
    n0.c[0] = 0;
...
function coeffToString(a2) {
  var s2, z, i = 1, j = a2.length, r = a2[0] + "";
  for (; i < j; ) {
    s2 = a2[i++] + "";
...
function compare(x, y2) {
  var a2, b, xc = x.c, yc = y2.c, i = x.s, j = y2.s, k = x.e, l2 = y2.e;
  if (!i || !j) return null;
  a2 = xc && !xc[0];
  b = yc && !yc[0];
...
var WuiInputText = class WuiInputText2 extends LitElement {
  ...
  dispatchInputChangeEvent() {
    ...
    this.dispatchEvent(new CustomEvent("inputChange", {
      detail: (_a4 = this.inputElementRef.value) == null ? void 0 : _a4.value,
      bubbles: true,
      composed: true
    }));
  }
...
var WuiTransactionListItem = class WuiTransactionListItem2 extends LitElement {
  ...
  templateDescription() {
    var _a4;
    const description = (_a4 = this.descriptions) == null ? void 0 : _a4[0];
  ...
  templateSecondDescription() {
    var _a4;
    const description = (_a4 = this.descriptions) == null ? void 0 : _a4[1];
    return description ? html`
...
var WuiOtp = class WuiOtp2 extends LitElement {
  ...
  firstUpdated() {
    ...
    const numericElements = (_a4 = this.shadowRoot) == null ? void 0 : _a4.querySelectorAll("wui-input-numeric");
    if (numericElements) {
  ...
  getInputElement(el) {
    var _a4;
    if ((_a4 = el.shadowRoot) == null ? void 0 : _a4.querySelector("input")) {
  ...
  generate(uri, size, logoSize) {
    ...
    circles.forEach(([cx, cy]) => {
      ...
      if (circlesToConnect[cx]) {
        (_a4 = circlesToConnect[cx]) == null ? void 0 : _a4.push(cy);
      } else {
    ...
    return this.tabs.map((tab, index) => {
      ...
      return html`
        <button
          ...
          data-testid="tab-${(_a4 = tab.label) == null ? void 0 : _a4.toLowerCase()}"
        >
...
var WuiTokenListItem = class WuiTokenListItem2 extends LitElement {
  ...
  render() {
    var _a4;
    const value = this.amount && this.price ? (_a4 = NumberUtil.multiply(this.price, this.amount)) == null ? void 0 : _a4.toFixed(3) : null;
    return html`
      <wui-flex alignItems="center">
        ${this.visualTemplate()}
        <wui-flex flexDirection="column" gap="3xs">
...
var WuiListAccordion = class WuiListAccordion2 extends LitElement {
  ...
  checkHeight() {
    this.updateComplete.then(() => {
      var _a4, _b3;
      const heightElement = (_a4 = this.shadowRoot) == null ? void 0 : _a4.querySelector(".heightContent");
  ...
  onClick() {
    var _a4;
    const icon = (_a4 = this.shadowRoot) == null ? void 0 : _a4.querySelector("wui-icon");
...
// node_modules/@web3modal/core/node_modules/proxy-compare/dist/index.modern.js
var e = Symbol();
var t = Symbol();
...
// node_modules/@web3modal/core/node_modules/valtio/esm/vanilla.mjs
...
// node_modules/@web3modal/core/node_modules/valtio/esm/vanilla/utils.mjs
...
var CoreHelperUtil = {
  ...
  isRestrictedRegion() {
    try {
      ...
      return ConstantsUtil2.RESTRICTED_TIMEZONES.includes(capTimeZone);
    } catch {
      return false;
    }
  },
  ...
  parseError(error) {
    ...
    if (typeof error === "string") {
      return error;
    } else if (typeof ((_b3 = (_a4 = error == null ? void 0 : error.issues) == null ? void 0 : _a4[0]) == null ? void 0 : _b3.message) === "string") {
...
// node_modules/@web3modal/core/node_modules/valtio/esm/react/utils.mjs
var import_react2 = __toESM(require_react(), 1);

// node_modules/@web3modal/core/node_modules/valtio/esm/react.mjs
...
var ConnectionController = {
  ...
  async connectExternal(options) {
    var _a4, _b3;
    await ((_b3 = (_a4 = this._getClient()).connectExternal) == null ? void 0 : _b3.call(_a4, options));
    StorageUtil.setConnectedConnector(options.type);
  },
  async reconnectExternal(options) {
    var _a4, _b3;
    await ((_b3 = (_a4 = this._getClient()).reconnectExternal) == null ? void 0 : _b3.call(_a4, options));
    StorageUtil.setConnectedConnector(options.type);
  },
  ...
  checkInstalled(ids) {
    var _a4, _b3;
    return (_b3 = (_a4 = this._getClient()).checkInstalled) == null ? void 0 : _b3.call(_a4, ids);
  },
  resetWcConnection() {
    state6.wcUri = void 0;
...
var NetworkController = {
  ...
  checkIfSupportedNetwork() {
    var _a4;
    state8.isUnsupportedChain = !((_a4 = state8.requestedCaipNetworks) == null ? void 0 : _a4.some((network) => {
      var _a5;
      return network.id === ((_a5 = state8.caipNetwork) == null ? void 0 : _a5.id);
    }));
  ...
  checkIfSmartAccountEnabled() {
    var _a4, _b3;
    const networkId = NetworkUtil.caipNetworkIdToNumber((_a4 = state8.caipNetwork) == null ? void 0 : _a4.id);
    if (!networkId) {
      return false;
    }
...
var SwapApiUtil = {
  async getTokenList() {
    ...
    const response = await BlockchainApiController.fetchSwapTokens({
      chainId: (_a4 = NetworkController.state.caipNetwork) == null ? void 0 : _a4.id,
      projectId: OptionsController.state.projectId
    });
    const tokens = ((_b3 = response == null ? void 0 : response.tokens) == null ? void 0 : _b3.map((token) => ({
      ...token,
      eip2612: false,
      quantity: {
        decimals: "0",
...
var RouterController = {
  ...
  popTransactionStack(cancel) {
    ...
    if (cancel) {
      this.goBack();
      (_a4 = action == null ? void 0 : action.onCancel) == null ? void 0 : _a4.call(action);
    } else {
      if (action.goBack) {
        this.goBack();
      } else if (action.view) {
...
var SwapCalculationUtil = {
  ...
  isInsufficientSourceTokenForSwap(sourceTokenAmount, sourceTokenAddress, balance) {
    var _a4, _b3;
    const sourceTokenBalance = (_b3 = (_a4 = balance == null ? void 0 : balance.find((token) => token.address === sourceTokenAddress)) == null ? void 0 : _a4.quantity) == null ? void 0 : _b3.numeric;
...
var SwapController = {
  ...
  getParams() {
    ...
    const networkAddress = `${(_a4 = NetworkController.state.caipNetwork) == null ? void 0 : _a4.id}:${ConstantsUtil2.NATIVE_TOKEN_ADDRESS}`;
    if (!address) {
      throw new Error("No address found to swap the tokens from.");
    }
    const caipAddress = AccountController.state.caipAddress;
    const invalidToToken = !((_b3 = state10.toToken) == null ? void 0 : _b3.address) || !((_c = state10.toToken) == null ? void 0 : _c.decimals);
    const invalidSourceToken = !((_d = state10.sourceToken) == null ? void 0 : _d.address) || !((_e = state10.sourceToken) == null ? void 0 : _e.decimals) || !NumberUtil.bigNumber(state10.sourceTokenAmount).isGreaterThan(0);
    const invalidSourceTokenAmount = !state10.sourceTokenAmount;
    return {
      networkAddress,
      fromAddress: address,
      fromCaipAddress: AccountController.state.caipAddress,
      sourceTokenAddress: (_f = state10.sourceToken) == null ? void 0 : _f.address,
      toTokenAddress: (_g = state10.toToken) == null ? void 0 : _g.address,
      toTokenAmount: state10.toTokenAmount,
      toTokenDecimals: (_h = state10.toToken) == null ? void 0 : _h.decimals,
      sourceTokenAmount: state10.sourceTokenAmount,
      sourceTokenDecimals: (_i = state10.sourceToken) == null ? void 0 : _i.decimals,
      invalidToToken,
      invalidSourceToken,
  ...
  resetValues() {
    ...
    const networkToken = (_a4 = state10.tokens) == null ? void 0 : _a4.find((token) => token.address === networkAddress);
  ...
  async getTokenList() {
    ...
    state10.popularTokens = tokens.sort((aTokenInfo, bTokenInfo) => {
      ...
      if (ConstantsUtil2.SWAP_POPULAR_TOKENS.includes(token.symbol)) {
        return true;
      }
      return false;
    }, {});
  ...
  async getInitialGasPrice() {
    ...
    return { gasPrice: gasFee, gasPriceInUSD: state10.gasPriceInUSD };
  },
  async swapTokens() {
    var _a4, _b3;
    const address = AccountController.state.address;
    ...
    const quoteToAmount = (_b3 = (_a4 = quoteResponse == null ? void 0 : quoteResponse.quotes) == null ? void 0 : _a4[0]) == null ? void 0 : _b3.toAmount;
    if (!quoteToAmount) {
      return;
    }
  ...
  async getTransaction() {
    ...
    const sourceToken = state10.sourceToken;
    const toToken = state10.toToken;
    if (!fromCaipAddress || !availableToSwap || !sourceToken || !toToken || state10.loading) {
      return void 0;
    }
    try {
      state10.loading = true;
  ...
  async sendTransactionForSwap(data) {
    ...
    try {
      const successMessage = `Swapped ${(_a4 = state10.sourceToken) == null ? void 0 : _a4.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b3 = state10.toToken) == null ? void 0 : _b3.symbol}!`;
      const forceUpdateAddresses = [(_c = state10.sourceToken) == null ? void 0 : _c.address, (_d = state10.toToken) == null ? void 0 : _d.address].join(",");
...
var AccountController = {
  ...
  setTokenBalance(tokenBalance) {
    if (tokenBalance) {
      state11.tokenBalance = ref2(tokenBalance);
    }
  },
  ...
  setSocialProvider(socialProvider) {
    if (socialProvider) {
      state11.socialProvider = socialProvider;
    }
  },
  setSocialWindow(socialWindow) {
    if (socialWindow) {
      state11.socialWindow = ref2(socialWindow);
    }
  },
  async fetchTokenBalance() {
    var _a4;
    const chainId = (_a4 = NetworkController.state.caipNetwork) == null ? void 0 : _a4.id;
    try {
      if (state11.address && chainId) {
        const response = await BlockchainApiController.getBalance(state11.address, chainId);
  ...
  resetAccount() {
    ...
    state11.socialProvider = void 0;
    state11.socialWindow = void 0;
  }
};
...
var ConnectorController = {
  ...
  setConnectors(connectors) {
    state14.connectors = connectors.map((c2) => ref2(c2));
  },
  addConnector(connector) {
    var _a4, _b3;
    state14.connectors.push(ref2(connector));
    if (connector.id === "w3mAuth") {
      const authConnector = connector;
      const optionsState = snapshot(OptionsController.state);
      const themeMode = ThemeController.getSnapshot().themeMode;
      const themeVariables = ThemeController.getSnapshot().themeVariables;
      (_b3 = (_a4 = authConnector == null ? void 0 : authConnector.provider) == null ? void 0 : _a4.syncDappData) == null ? void 0 : _b3.call(_a4, {
  ...
  getAnnouncedConnectorRdns() {
    return state14.connectors.filter((c2) => c2.type === "ANNOUNCED").map((c2) => {
      var _a4;
      return (_a4 = c2.info) == null ? void 0 : _a4.rdns;
    });
  },
  getConnectors() {
  ...
  getConnector(id, rdns) {
    return state14.connectors.find((c2) => {
      var _a4;
      return c2.explorerId === id || ((_a4 = c2.info) == null ? void 0 : _a4.rdns) === rdns;
    });
  }
};
...
var ApiController = {
  ...
  async fetchRecommendedWallets() {
    ...
    const { data, count } = await api3.get({
      ...
      params: {
        page: "1",
        chains: (_a4 = NetworkController.state.caipNetwork) == null ? void 0 : _a4.id,
  ...
  async getQuote() {
    ...
    try {
      const quote = await BlockchainApiController.getOnrampQuote({
        ...
        amount: ((_a4 = state17.paymentAmount) == null ? void 0 : _a4.toString()) || "0",
...
var SendController = {
  ...
  sendToken() {
    var _a4, _b3;
    if (((_a4 = this.state.token) == null ? void 0 : _a4.address) && this.state.sendTokenAmount && this.state.receiverAddress) {
      this.sendERC20Token({
    ...
    } else if (this.state.receiverAddress && this.state.sendTokenAmount && this.state.gasPrice && ((_b3 = this.state.token) == null ? void 0 : _b3.quantity.decimals)) {
...
var EnsController = {
  ...
  async resolveName(name) {
    ...
    try {
      ...
      const error = e2;
      throw new Error(((_b3 = (_a4 = error == null ? void 0 : error.reasons) == null ? void 0 : _a4[0]) == null ? void 0 : _b3.description) || "Error resolving name");
    }
  },
  ...
  parseEnsApiError(error, defaultError) {
    ...
    return ((_b3 = (_a4 = ensError == null ? void 0 : ensError.reasons) == null ? void 0 : _a4[0]) == null ? void 0 : _b3.description) || defaultError;
  },
  isAllowedToRegisterName() {
    var _a4;
    const emailConnector = ConnectorController.getAuthConnector();
    const email = (emailConnector == null ? void 0 : emailConnector.provider.getEmail()) || "";
    const domain = (_a4 = email.split("@")) == null ? void 0 : _a4[1];
...
var WuiOnRampProviderItem = class WuiOnRampProviderItem2 extends LitElement {
  ...
  networksTemplate() {
    ...
    const slicedNetworks = (_a4 = networks == null ? void 0 : networks.filter((network) => network == null ? void 0 : network.imageId)) == null ? void 0 : _a4.slice(0, 5);
    return html`
...
var WuiInputAmount = class WuiInputAmount2 extends LitElement {
  ...
  render() {
    var _a4;
    if (((_a4 = this.inputElementRef) == null ? void 0 : _a4.value) && this.value) {
  ...
  dispatchInputChangeEvent(e2) {
    ...
    if (inputChar && ((_a4 = this.inputElementRef) == null ? void 0 : _a4.value)) {
      if (inputChar === ",") {
...
WuiIconButton.styles = [resetStyles, elementStyles, styles_default67];
__decorate67([
  property()
...
WuiListButton.styles = [resetStyles, elementStyles, styles_default68];
__decorate68([
  property()
...
WuiListSocial.styles = [resetStyles, elementStyles, styles_default69];
__decorate69([
  property()
...
WuiGrid.styles = [resetStyles, styles_default70];
__decorate70([
  property()
...
WuiSeparator.styles = [resetStyles, styles_default71];
__decorate71([
  property()
], WuiSeparator.prototype, "text", void 0);
WuiSeparator = __decorate71([
...
var TransactionUtil = {
  ...
  getTransactionImageURL(transfer) {
    ...
    if (transfer && isNFT) {
      imageURL = (_c = (_b3 = (_a4 = transfer == null ? void 0 : transfer.nft_info) == null ? void 0 : _a4.content) == null ? void 0 : _b3.preview) == null ? void 0 : _c.url;
  ...
  getTransactionDescriptions(transaction) {
    var _a4, _b3, _c;
    const type = (_a4 = transaction == null ? void 0 : transaction.metadata) == null ? void 0 : _a4.operationType;
  ...
  getTransferDescription(transfer) {
    ...
    if (transfer == null ? void 0 : transfer.nft_info) {
      description = ((_a4 = transfer == null ? void 0 : transfer.nft_info) == null ? void 0 : _a4.name) || "-";
  ...
  getFungibleTransferDescription(transfer) {
    ...
    const description = [quantity, (_a4 = transfer == null ? void 0 : transfer.fungible_info) == null ? void 0 : _a4.symbol].join(" ").trim();
    return description;
  },
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UE6WUVGF.js.map
