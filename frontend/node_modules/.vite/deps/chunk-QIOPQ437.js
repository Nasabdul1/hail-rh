...
var RpcRequestError = class extends BaseError {
  constructor({ body, error, url }) {
    super("RPC Request failed.", {
      ...
      metaMessages: [`URL: ${getUrl2(url)}`, `Request body: ${stringify(body)}`],
...
async function call(client, args) {
  ...
  try {
    ...
    const { offchainLookup: offchainLookup2, offchainLookupSignature: offchainLookupSignature2 } = await import("./ccip-Z4TQDLNX.js");
...
//# sourceMappingURL=chunk-QIOPQ437.js.map
