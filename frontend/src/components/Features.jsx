...
const FEATURES = [
  {
    ...
    title: 'Real Voice',
    body: 'WebRTC peer-to-peer audio streaming. Your voice never touches our servers.'
  },
  {
    icon: (
    ...
    body: 'Every call is recorded on Robinhood Chain. Permanent, verifiable, transparent.'
  },
  {
    icon: (
    ...
    title: 'Truly Free',
    body: 'No subscription. No per-call fee. Just network gas — and we sponsor your first calls.'
  },
  {
    icon: (
    ...
    title: 'Self-Custody',
    body: 'Generate a wallet in one tap, or bring your own via WalletConnect. Your keys, always.'
  },
  {
    icon: (
    ...
    title: 'Address Book',
    body: 'Save contacts by name. No phone numbers needed — just wallet addresses.'
  },
  {
    icon: (
    ...
    title: 'Sub-Second',
    body: 'Ring any wallet in under a second. Real-time WebSocket signaling + on-chain settlement.'
  }
]
    ...
    <section className="features" id="features">
      <div className="container">
        <div className="section-head">
          <span className="section-kicker">Why Hail.rh</span>
          <h2 className="section-title">Built for the<br />on-chain generation.</h2>
        </div>
